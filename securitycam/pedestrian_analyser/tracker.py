...
import cv2
import numpy as np
from securitycam.select_roi import SelectROI
...
if __name__ == '__main__':
    ...
    # output_fname = '/home/tomas/temp/cv_seminar/tracker_tld_025.avi'
    # fourcc = cv2.VideoWriter_fourcc(*'XVID')
    # video_writer = cv2.VideoWriter(output_fname, fourcc, 20.0, (frame.shape[1], frame.shape[0]), True)
    ...
    # video_writer = cv2.VideoWriter(output_fname, fourcc, 30.0, (frame.shape[1], frame.shape[0]), True)
